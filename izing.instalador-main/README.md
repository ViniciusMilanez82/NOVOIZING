...
## Problema de Mensagens Duplicadas ##

Se você está vendo mensagens duplicadas na interface (uma com relógio de enviando e outra com 2 traços de enviado), execute o script de correção:
...
Ou consulte o arquivo `INSTRUCOES-CORRECAO.md` para instruções detalhadas.
