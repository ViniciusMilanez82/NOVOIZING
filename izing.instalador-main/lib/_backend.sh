...
#######################################
# fixes duplicate messages issue in frontend
# Arguments:
#   None
#######################################
backend_fix_duplicate_messages() {
  print_banner
  ...
  # Criar arquivo de correção para mensagens duplicadas
  ...
  function fixDuplicateMessages(dir) {
    ...
    files.forEach(file => {
      ...
      if (stat.isDirectory()) {
        ...
        // Corrigir lógica de envio de mensagens
...
#######################################
# fixes duplicate messages issue in backend
# Arguments:
#   None
#######################################
backend_fix_duplicate_messages_backend() {
  print_banner
  printf "${WHITE} 💻 Corrigindo problema de mensagens duplicadas no backend...${GRAY_LIGHT}"
  printf "\n\n"
  ...
  # Criar arquivo de correção para mensagens duplicadas no backend
  ...
  function fixBackendDuplicateMessages(dir) {
    ...
    files.forEach(file => {
      ...
      if (stat.isDirectory()) {
        ...
        // Corrigir lógica de envio de mensagens no backend
